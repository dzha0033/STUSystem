...
<div class="div_head" style="width: 100%;text-align:center;">
		<span> <span style="float:left">当前位置是：权限管理-》人员管理</span> <span
            ...
            <a style="text-decoration: none;" href="/power/user/users?method=add">【新增人员】</a>&nbsp;&nbsp;&nbsp;&nbsp;
		</span>
		</span>
</div>
...
<div class="cztable" style="width: 100%;">
    ...
    <div class='MainStyle'>
        <div class=''><a href='/power/user/users?method=select' target='_self'>首页</a>
        </div>
        ...
        <div class=''><a href='/power/user/users?method=select&index=${indexa}' target='_self'>${indexa}</a></div>
        </div>
        </c:forEach>
        <div class=''><a href='/power/user/users?method=select&index=${pi.pageIndex+1>= pi.totalPages?pi.totalPages:pi.pageIndex+1}' target='_self'>下一页</a>
        </div>
        <div class=''><a href='/power/user/users?method=select&index=${pi.totalPages}' target='_self'>尾页</a>
        </div>
